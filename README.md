# Parenting — `oriz-blog-parenting`

> Raising humans, one hard day at a time — practical, judgement-free parenting notes.

[![License: MIT](https://img.shields.io/badge/License-MIT-e4572e.svg)](./LICENSE)
[![GitHub stars](https://img.shields.io/github/stars/chirag127/oriz-blog-parenting?style=flat)](https://github.com/chirag127/oriz-blog-parenting/stargazers)
[![Last commit](https://img.shields.io/github/last-commit/chirag127/oriz-blog-parenting)](https://github.com/chirag127/oriz-blog-parenting/commits/main)
[![Deploy](https://github.com/chirag127/oriz-blog-parenting/actions/workflows/deploy.yml/badge.svg)](https://github.com/chirag127/oriz-blog-parenting/actions/workflows/deploy.yml)
[![Built with Astro](https://img.shields.io/badge/built%20with-Astro-ff5d01.svg)](https://astro.build)

**Parenting** is a static, content-first blog built with Astro and deployed to Cloudflare Pages.
A parenting blog with practical, judgement-free notes on child development, routines, and family life across the ages and stages.

- **Live site:** https://parenting-blog.oriz.in · **Repo:** https://github.com/chirag127/oriz-blog-parenting
- **GitHub Pages landing:** https://chirag127.github.io/oriz-blog-parenting/ — the canonical, always-current site is **https://parenting-blog.oriz.in** (Cloudflare Pages); GitHub Pages is not the deploy target for this repo.

> ⭐ **If this is useful, please [star the repo](https://github.com/chirag127/oriz-blog-parenting/stargazers)** — it helps others find it.
...
flowchart LR
    ...
    D --> E["Cloudflare Pages<br/>parenting-blog.oriz.in"]
...
oriz-blog-parenting/
├── src/
│   ├── content/blog/       # the parenting guides (MDX/Markdown)
