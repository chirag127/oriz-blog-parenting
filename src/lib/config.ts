...
export const SITE_CONFIG: BlogConfig = {
  title: 'Kitchen Table',
  description:
    'Calm, practical, judgement-free writing on raising kids: screens, sleep, reading, routines, and the ordinary days in between.',
  url: 'https://parenting-blog.oriz.in',
  defaultLocale: 'en',
  author: {
    name: 'Chirag Singhal',
  ...
  giscus: {
    repo: env('PUBLIC_GISCUS_REPO', 'chirag127/oriz-blog-parenting') as `${string}/${string}`,
